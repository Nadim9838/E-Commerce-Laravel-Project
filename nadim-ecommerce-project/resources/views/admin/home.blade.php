...
<head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('admin//images/situ_watch_factory_icon.ico') }}">
        ...
        <div id="layout-wrapper">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/') }}/images/logo-dark.png" alt="logo-sm-dark" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/') }}/images/logo-sm-dark.png" alt="logo-dark" height="25">
                                </span>
                            </a>

                            <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/') }}/images/logo-light.png" alt="logo-sm-light" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/') }}/images/logo-sm-light.png" alt="logo-light" height="25">
                                </span>
                            </a>
                        </div>
                      ...
                      <div class="page-title-box align-self-center d-none d-md-block">
                        <h4 class="page-title mb-0">Nadim E-Commerce Project Dashboard</h4>
                      </div>
                      <!-- end page title -->
                    </div>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div data-simplebar style="max-height: 230px;">
                                    ...
                                    <a href="#" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <img src="{{ asset('admin/') }}/images/users/avatar-4.jpg"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
            ...
            <div class="vertical-menu">
                 ...
                 <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('admin/') }}/images/logo-sm-dark.png" alt="logo-sm-dark" height="24">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('admin/') }}/images/logo-dark.png" alt="logo-dark" height="22">
                        </span>
                    </a>

                    <a href="index.html" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ asset('admin/') }}/images/logo-sm-light.png" alt="logo-sm-light" height="24">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('admin/') }}/images/situ_watch_factory_logo.png" alt="logo-light" height="75">
                        </span>
                    </a>
                </div>
                ...
                <div class="dropdown px-3 sidebar-user sidebar-user-info">
                    <button type="button" class="btn w-100 px-0 border-0" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                    <img src="{{ asset('admin/') }}/images/users/avatar-2.jpg" class="img-fluid header-profile-user rounded-circle" alt="">
                            </div>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/') }}/images/users/avatar-2.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Neal Matthews</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/') }}/images/users/avatar-3.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Jamal Burnett</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/') }}/images/users/avatar-4.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Juan Mitchell</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/') }}/images/users/avatar-5.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Barry Dick</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/') }}/images/users/avatar-6.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Ronald Taylor</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/') }}/images/users/avatar-7.jpg" class="avatar-xs rounded-circle me-2" alt="..."> Jacob Hunter</td>
